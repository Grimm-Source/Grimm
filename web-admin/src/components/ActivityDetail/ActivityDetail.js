    ...
    render() {
        ...
        return (
            this.props.loading ? <Spin size="large"/> :
                <Form className="activity-form" {...formItemLayout} onSubmit={this.handleSubmit}>
                    <Form.Item style={{marginBottom: 0}} htmlFor="date-item" label="活动时间">
                        <Form.Item style={{display: 'inline-block', width: '45%'}}>
                            ...
                            })(<RangePicker disabledDate={disabledDate} onChange={this.changeDate}
                    ...
                    <Form.Item htmlFor="count-item" label="招募人数">
                        <div className="impaired-detail">
                            ...
                            <Form.Item style={{marginBottom: "12px", display: 'inline-block'}}>{
                                ...
                                })(<InputNumber min={0} disabled={!this.state.isDisabledLimited} type="number"
                                                id="vision_impaired_capacity" placeholder="请输入视障人士人数"/>)
                            }</Form.Item>
                        </div>
                        <div className="volunteer-detail">
                            ...
                            <Form.Item label="岗位人数" style={{display: 'inline-block', width: '50%'}}>{
                                ...
                                })(<InputNumber disabled={!this.state.isVolLimited} min={0} type="number"
                                                id="volunteer_capacity" placeholder="请输入志愿者人数"/>)
                            }</Form.Item>
                    ...
                    <Form.Item label="活动费用">
                        ...
                        <Form.Item style={{display: 'inline-block', marginBottom: "0"}}>{
                            ...
                            })(<InputNumber disabled={!this.state.isFeeNeeded} min={0} type="number" id="expense"
                                            placeholder="请输入活动费用"/>)
                        }</Form.Item>
